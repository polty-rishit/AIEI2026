...
<div className="bg-gray-50 flex justify-center -mt-10 mb-16 py-4">
  <a href='https://cmt3.research.microsoft.com/AIEI2027' className="relative flex items-center gap-3 px-6 py-3 bg-green-100 text-green-700 font-semibold rounded-full shadow-md hover:bg-green-200 transition duration-300">
    {/* Animated Dot */}
