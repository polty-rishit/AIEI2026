...
<h3 className="text-5xl md:text-7xl font-bold mb-4">AIEI 2026</h3>
  ...
  {/* Countdown Timer */}
  <div className="bg-white bg-opacity-90 backdrop-blur-sm rounded-xl shadow-xl p-4 sm:p-6 mb-30 w-full max-w-2xl mx-auto">
  ...
  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 text-center">
    {/* Days */}
    <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-lg p-3 sm:p-4 shadow-md">
