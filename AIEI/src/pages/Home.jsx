...
<h3 className="text-5xl md:text-7xl font-bold mb-4">AIEI 2026</h3>
  ...
  {/* Countdown Timer */}
  <div className="bg-white bg-opacity-90 backdrop-blur-sm rounded-xl shadow-xl p-6 mb-30 w-full max-w-2xl">
    <h3 className="text-2xl font-bold text-center text-gray-800 mb-6">
      Conference Starts In
    </h3>
    <div className="grid grid-cols-4 gap-4 text-center">
      <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-lg p-4 shadow-md">
        <div className="text-4xl font-bold countdown-number" id="days">
          00
        </div>
        <div className="text-sm uppercase tracking-wider">Days</div>
      </div>
      <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-lg p-4 shadow-md">
        <div className="text-4xl font-bold countdown-number" id="hours">
          00
        </div>
        <div className="text-sm uppercase tracking-wider">Hours</div>
      </div>
      <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-lg p-4 shadow-md">
        <div className="text-4xl font-bold countdown-number" id="minutes">
          00
        </div>
        <div className="text-sm uppercase tracking-wider">Minutes</div>
      </div>
      <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-lg p-4 shadow-md">
        <div className="text-4xl font-bold countdown-number" id="seconds">
          00
        </div>
