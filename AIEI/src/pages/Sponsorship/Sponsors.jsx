          ...
          <TiltedCard
            ...
            overlayContent={
              <div className="text-gray-900 p-5 w-[240px]">
                ...
                <p className="text-sm">
                  Engage face-to-face with over 500 experts in green tech, smart
                  systems, robotics, power electronics, and more.
                </p>
              </div>
            }
          />
          ...
          <TiltedCard
            ...
            overlayContent={
              <div className="text-gray-900 p-5 w-[240px]">
                ...
                <p className="text-sm">
                  Position your brand as an industry leader and stay ahead with
                  the latest trends.
                </p>
              </div>
            }
          ...
          <table className="min-w-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-pink-300">
            ...
            <thead>
              <tr className="bg-gradient-to-r from-pink-500 to-pink-400 text-white text-lg md:text-xl font-extrabold tracking-wide">
                <th className="py-6 px-4 border border-pink-300 text-left">
                  CATEGORY
                </th>
                <th className="py-6 px-4 border border-pink-300">AMOUNT</th>
                <th className="py-6 px-4 border border-pink-300">
                  EXHIBITION STALL
                </th>
                <th className="py-6 px-4 border border-pink-300">
                  FREE DELEGATES
            ...
            <tbody className="text-center text-gray-900 font-semibold text-lg">
              ...
              <tr className="bg-pink-50 hover:bg-pink-100 transition-all duration-200">
                <td className="py-6 px-4 border border-pink-200 text-pink-700 font-bold text-lg tracking-wide">
                  SIGNATURE
                </td>
                ...
                <td className="py-6 border border-pink-200 font-extrabold text-2xl">
                  6
                </td>
                <td className="py-6 border border-pink-200">
                  <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-pink-200 text-pink-700 text-3xl font-black">
                    ✔
                  </span>
                </td>
                <td className="py-6 border border-pink-200">
              ...
              <tr className="bg-pink-50 hover:bg-pink-100 transition-all duration-200">
                ...
                <td className="py-6 border border-pink-200">
                  <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-red-200 text-red-600 text-3xl font-black">
                    ✖
                  </span>
                </td>
                <td className="py-6 border border-pink-200">
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-[#5baec0] text-white text-xl font-extrabold tracking-wide">
                    <th className="py-5 px-6 border-r border-[#cfe8ed] text-left">
                      ITEMS
                    </th>
                ...
                <tbody className="text-gray-900 text-lg font-semibold">
                  {[
                    ...
                    [
                      ...
                      "Branding in official photos & videos",
                    ],
          ...
          <div className="w-full lg:w-1/2 space-y-12">
            ...
            {/* <div>
              ...
              <div className="text-gray-800 text-lg font-semibold space-y-3 leading-relaxed pl-2">
                <p>
                  • Account No.:{" "}
                  <span className="font-extrabold">38246478714</span>
                </p>
                <p>
                  • Account Name:{" "}
                  <span className="font-extrabold">
                    NIT JAMSHEDPUR RESEARCH AND TECHNOLOGY
                  </span>
                </p>
                <p>
                  • Bank Name:{" "}
                  <span className="font-extrabold">State Bank of India</span>
                </p>
                <p>
                  • IFSC Code:{" "}
                  <span className="font-extrabold">SBIN0001882</span>
                </p>
              </div>
            </div> */}
